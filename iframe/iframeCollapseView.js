    ...
    firebase.functions().httpsCallable('getUrlInfo')({'url' : url})
      .then( function(result) {
        ...
        if ( typeof(result.error) === "undefined" ) {
          ...
          console.log('isStarred returned', result.data.isStarred)
          ...
          console.log('isflagged returned', result.data.isFlagged)
          ...
          displayError('Error fetching feed. Please try re-installing.')
        }
        //chrome.storage.sync.set({data: result}, function() {
      });
}
